...
// export module Markers {
  ...
  export const GREAT_BRIDGE_SETTLEMENT_REQUIREMENT = Type.GREAT_BRIDGE_SETTLEMENT_REQUIREMENT;
  export const GREAT_WALL_SETTLEMENTS_REQUIREMENT = Type.GREAT_WALL_SETTLEMENTS_REQUIREMENT;
