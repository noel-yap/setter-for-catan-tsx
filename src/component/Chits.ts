// export module Chits {
  ...
  export const BASE_3_EXP_SEA_SCEN_OC_FACE_UP_PRODUCING_TERRAIN_CHIT_SET = [CHITS_3, CHITS_4, CHITS_10, CHITS_12]
      .concat(new Array(2).fill(CHITS_5))
      .concat(new Array(2).fill(CHITS_6))
      .concat(new Array(2).fill(CHITS_8))
      .concat(new Array(2).fill(CHITS_9))
  ...
  export const BASE_4_EXP_SEA_SCEN_OC_FACE_UP_PRODUCING_TERRAIN_CHIT_SET = [CHITS_2, CHITS_11, CHITS_12]
      .concat(new Array(2).fill(CHITS_3))
      .concat(new Array(2).fill(CHITS_4))
      .concat(new Array(2).fill(CHITS_5))
      .concat(new Array(2).fill(CHITS_6))
  ...
  export const EXT_7_8_EXP_SEA_SCEN_OC_FACE_UP_PRODUCING_TERRAIN_CHIT_SET = [CHITS_2_12]
      ...
      .concat(new Array(3).fill(CHITS_6))
      .concat(new Array(3).fill(CHITS_8));
  export const EXT_7_8_EXP_SEA_SCEN_OC_FACE_DOWN_PRODUCING_TERRAIN_CHIT_SET = [CHITS_2, CHITS_12]
      .concat(new Array(2).fill(CHITS_3))
      .concat(new Array(2).fill(CHITS_11))
      .concat(new Array(3).fill(CHITS_4))
      .concat(new Array(3).fill(CHITS_10))
  ...
  export const BASE_3_EXP_SEA_SCEN_TD_INDIGENOUS_ISLAND_PRODUCING_TERRAIN_CHIT_SET = [CHITS_2, CHITS_3, CHITS_5, CHITS_11]
      .concat(new Array(2).fill(CHITS_4))
      .concat(new Array(2).fill(CHITS_6))
      .concat(new Array(2).fill(CHITS_8))
      .concat(new Array(2).fill(CHITS_9))
      .concat(new Array(2).fill(CHITS_10));
  export const BASE_3_EXP_SEA_SCEN_TD_FOREIGN_ISLAND_PRODUCING_TERRAIN_CHIT_SET = new Array(2).fill(CHITS_5)
      .concat([CHITS_3, CHITS_4, CHITS_6, CHITS_8, CHITS_9, CHITS_11]);

  export const BASE_4_EXP_SEA_SCEN_TD_INDIGENOUS_ISLAND_PRODUCING_TERRAIN_CHIT_SET = [CHITS_12]
      .concat(new Array(2).fill(CHITS_3))
      .concat(new Array(2).fill(CHITS_4))
      .concat(new Array(2).fill(CHITS_5))
      .concat(new Array(2).fill(CHITS_6))
  ...
  export const EXT_5_6_EXP_SEA_SCEN_TD_INDIGENOUS_ISLAND_PRODUCING_TERRAIN_CHIT_SET = [CHITS_2]
      .concat(new Array(2).fill(CHITS_3))
      .concat(new Array(2).fill(CHITS_4))
      .concat(new Array(2).fill(CHITS_5))
      .concat(new Array(2).fill(CHITS_6))
      ...
      .concat(new Array(2).fill(CHITS_11))
      .concat(new Array(2).fill(CHITS_12));
  export const EXT_5_6_EXP_SEA_SCEN_TD_FOREIGN_ISLAND_PRODUCING_TERRAIN_CHIT_SET = [CHITS_9, CHITS_10, CHITS_12]
      .concat(new Array(2).fill(CHITS_2))
      .concat(new Array(2).fill(CHITS_3))
      .concat(new Array(2).fill(CHITS_4))
      .concat(new Array(2).fill(CHITS_5))
  ...
  export const EXT_7_8_EXP_SEA_SCEN_TD_INDIGENOUS_ISLAND_PRODUCING_TERRAIN_CHIT_SET = [CHITS_2, CHITS_12]
      .concat(new Array(2).fill(CHITS_3))
      .concat(new Array(3).fill(CHITS_4))
      .concat(new Array(4).fill(CHITS_5))
      .concat(new Array(3).fill(CHITS_6))
      ...
      .concat(new Array(3).fill(CHITS_10))
      .concat(new Array(2).fill(CHITS_11));
  export const EXT_7_8_EXP_SEA_SCEN_TD_FOREIGN_ISLAND_PRODUCING_TERRAIN_CHIT_SET = new Array(2).fill(CHITS_2)
      .concat(new Array(3).fill(CHITS_3))
      .concat(new Array(3).fill(CHITS_4))
      .concat(new Array(3).fill(CHITS_5))
      .concat(new Array(3).fill(CHITS_6))
  ...
  export const EXT_5_6_EXP_SEA_SCEN_FT_MAIN_ISLAND_TERRAIN_CHIT_SET = [CHITS_2, CHITS_12]
      .concat(new Array(3).fill(CHITS_6))
      .concat(new Array(3).fill(CHITS_8))
      .concat(new Array(3).fill(CHITS_9))
      .concat(new Array(3).fill(CHITS_10))
  ...
  export const BASE_3_4_EXP_SEA_SCEN_CFC_MAIN_ISLAND_TERRAIN_CHIT_SET = [CHITS_2, CHITS_12]
      .concat(BASE_3_4_PRODUCING_TERRAIN_CHIT_SET);
  export const BASE_3_4_EXP_SEA_SCEN_CFC_SMALL_ISLAND_3_11_CHIT_CHIT_SET = [CHITS_3, CHITS_11];
  export const BASE_3_4_EXP_SEA_SCEN_CFC_SMALL_ISLAND_4_10_CHIT_CHIT_SET = [CHITS_4, CHITS_10];
  ...
  export const EXT_5_6_EXP_SEA_SCEN_CFC_MAIN_ISLAND_TERRAIN_CHIT_SET = [CHITS_6, CHITS_8]
  ...
  export const EXT_7_8_EXP_SEA_SCEN_CFC_MAIN_ISLAND_TERRAIN_CHIT_SET =   EXT_5_6_EXP_SEA_SCEN_CFC_MAIN_ISLAND_TERRAIN_CHIT_SET
      .concat([CHITS_2, CHITS_4, CHITS_5, CHITS_9, CHITS_10, CHITS_12]);
  export const EXT_7_8_EXP_SEA_SCEN_CFC_SMALL_ISLAND_2_12_CHIT_CHIT_SET = new Array(2).fill(CHITS_2)
      .concat(new Array(2).fill(CHITS_12));
  export const EXT_7_8_EXP_SEA_SCEN_CFC_SMALL_ISLAND_4_10_CHIT_CHIT_SET = new Array(2).fill(CHITS_4)
      .concat(new Array(2).fill(CHITS_10));
  export const EXT_7_8_EXP_SEA_SCEN_CFC_SMALL_ISLAND_5_9_CHIT_CHIT_SET = new Array(2).fill(CHITS_5)
      .concat(new Array(2).fill(CHITS_9));
  ...
  export const EXT_7_8_EXP_SEA_SCEN_WOC_MAIN_ISLAND_PRODUCING_TERRAIN_CHIT_SET = [CHITS_2_12]
      .concat(new Array(3).fill(CHITS_2))
      .concat(new Array(4).fill(CHITS_3))
      .concat(new Array(4).fill(CHITS_4))
      .concat(new Array(4).fill(CHITS_5))
      ...
      .concat(new Array(4).fill(CHITS_11))
      .concat(new Array(3).fill(CHITS_12));
  export const EXT_7_8_EXP_SEA_SCEN_WOC_SMALL_ISLAND_GOLD_CHIT_SET = new Array(2).fill(CHITS_6)
      .concat(new Array(2).fill(CHITS_8));
