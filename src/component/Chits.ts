...
export class Chits {
  ...
  export const EXTENSION_5_6_PRODUCING_TERRAIN_CHIT_SET = BASE_3_4_PRODUCING_TERRAIN_CHIT_SET
  ...
  export const EXTENSION_7_8_PRODUCING_TERRAIN_CHIT_SET = BASE_3_4_PRODUCING_TERRAIN_CHIT_SET
  ...
  export const EXTENSION_5_6_EXPANSION_SEA_SCENARIO_HFNS_SMALL_ISLANDS_PRODUCING_TERRAIN_CHIT_SET = BASE_4_EXPANSION_SEA_SCENARIO_HFNS_SMALL_ISLANDS_PRODUCING_TERRAIN_CHIT_SET
      .concat([CHITS_12]);

  export const EXTENSION_7_8_EXPANSION_SEA_SCENARIO_HFNS_SMALL_ISLANDS_PRODUCING_TERRAIN_CHIT_SET = EXTENSION_5_6_EXPANSION_SEA_SCENARIO_HFNS_SMALL_ISLANDS_PRODUCING_TERRAIN_CHIT_SET
      .concat(EXTENSION_5_6_EXPANSION_SEA_SCENARIO_HFNS_SMALL_ISLANDS_PRODUCING_TERRAIN_CHIT_SET);
  ...
  export const BASE_4_EXPANSION_SEA_SCENARIO_FI_FACE_UP_PRODUCING_TERRAIN_CHIT_SET = [CHITS_2, CHITS_11, CHITS_12]
      .concat(new Array(2).fill(CHITS_3))
      .concat(new Array(2).fill(CHITS_4))
      .concat(new Array(2).fill(CHITS_5))
      .concat(new Array(2).fill(CHITS_6))
  ...
  export const EXTENSION_5_6_EXPANSION_SEA_SCENARIO_FI_FACE_UP_PRODUCING_TERRAIN_CHIT_SET = [CHITS_2]
      .concat(new Array(2).fill(CHITS_4))
      .concat(new Array(2).fill(CHITS_5))
      .concat(new Array(2).fill(CHITS_9))
      .concat(new Array(2).fill(CHITS_10))
