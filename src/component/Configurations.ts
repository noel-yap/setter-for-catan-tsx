...
// export module Configurations {
  ...
  export const CONFIGURATION_7_8_EXPANSION_SEA_SCENARIO_HFNS = new Configuration(CONFIGURATION_7_8.settings
  ...
  export const CONFIGURATION_7_8_EXPANSION_SEA_SCENARIO_HFNS_FISHERMEN = new Configuration(CONFIGURATION_7_8_FISHERMEN.settings
      .filter((c) => c[0] === Coordinates.EXTENSION_7_8_TERRAIN_COORDINATES)
      .map((c) => {
        return [Coordinates.EXTENSION_7_8_EXPANSION_SEA_SCENARIO_HFNS_BIG_ISLAND_TERRAIN_COORDINATES, c[1]] as [Coordinates.Coordinate[], TileChitBag[]];
      })
  ...
  export const CONFIGURATION_4_EXPANSION_SEA_SCENARIO_FI = new Configuration([
    ...
    [Coordinates.BASE_4_EXPANSION_SEA_SCENARIO_FI_FACE_DOWN_PRODUCING_TERRAIN_COORDINATES,
      [new TileChitBag(new Array(12).fill(Tiles.UNKNOWN))]]]);
  export const CONFIGURATION_4_EXPANSION_SEA_SCENARIO_FI_FISHERMEN = new Configuration(CONFIGURATION_4_EXPANSION_SEA_SCENARIO_FI.settings
      .concat([
