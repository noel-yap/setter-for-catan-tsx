// export module Coordinates {
  ...
  export const BASE_3_EXPANSION_SEA_SCENARIO_FI_FACE_DOWN_COORDINATES = [
    new Coordinate(9, 1),
    new Coordinate(11, 1),
    new Coordinate(10, 2),
    new Coordinate(12, 2),
  ...
  export const BASE_4_EXPANSION_SEA_SCENARIO_FI_FACE_DOWN_COORDINATES = [
    new Coordinate(9, 1),
    new Coordinate(11, 1),
    new Coordinate(8, 2),
    new Coordinate(10, 2),
  ...
  export const EXTENSION_5_6_EXPANSION_SEA_SCENARIO_FI_GOLD_TERRAIN_COORDINATES = [
    new Coordinate(3, 1),
    new Coordinate(17, 1)];
  export const EXTENSION_5_6_EXPANSION_SEA_SCENARIO_FI_FACE_DOWN_COORDINATES = [
    new Coordinate(5, 1),
    new Coordinate(7, 1),
    new Coordinate(9, 1),
    new Coordinate(11, 1),
  ...
  export const BASE_3_4_EXPANSION_TB_SCENARIO_ROC_NON_RIVER_TERRAIN_COORDINATES = [
    new Coordinate(4, 1),
    new Coordinate(6, 1),
    new Coordinate(8, 1),
    new Coordinate(2, 3),
  ...
  export const BASE_3_4_EXPANSION_TB_SCENARIO_ROC_NORTHERN_RIVER_PASTURE_TERRAIN_COORDINATES = [new Coordinate(5, 2)];
  export const BASE_3_4_EXPANSION_TB_SCENARIO_ROC_NORTHERN_RIVER_HILL_TERRAIN_COORDINATES = [new Coordinate(7, 2)];
  export const BASE_3_4_EXPANSION_TB_SCENARIO_ROC_NORTHERN_RIVER_MOUNTAIN_TERRAIN_COORDINATES = [new Coordinate(9, 2)];
  export const BASE_3_4_EXPANSION_TB_SCENARIO_ROC_SOUTHERN_SWAMP_TERRAIN_COORDINATES = [new Coordinate(3, 4)];
  export const BASE_3_4_EXPANSION_TB_SCENARIO_ROC_SOUTHERN_RIVER_HILL_TERRAIN_COORDINATES = [new Coordinate(5, 4)];
  export const BASE_3_4_EXPANSION_TB_SCENARIO_ROC_SOUTHERN_RIVER_MOUNTAIN_TERRAIN_COORDINATES = [new Coordinate(7, 4)];
